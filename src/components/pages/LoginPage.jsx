...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if ((identifier === "user@gmail.com" || identifier === "+923001234567") && password === "123") {
        navigate("/dashboard");
    } else if (identifier === "admin1@gmail.com" && password === "123") {
      navigate("/admindashboard1");
    }
    else if (identifier === "admin2@gmail.com" && password === "123") {
      navigate("/admindashboard2");
    }
     else if (identifier === "creator@gmail.com" && password === "123") {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      {/* Left side image */}
      <div className="hidden md:block md:w-1/2">
        <img src={boyImg} alt="Travel" className="w-full h-full object-cover" />
      </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-gradient-to-b from-gray-900 to-black relative p-6">
        ...
        <div className="bg-transparent w-full max-w-[380px] p-6 md:p-8">
          <h2 className="text-2xl md:text-3xl font-semibold text-white text-center mb-2">Welcome back</h2>
